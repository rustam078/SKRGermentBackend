...
public class ProductionController {
    ...
    @PostMapping
    public CommonResponse<ProductionResponse> create(
            @Valid
            @RequestBody
            CreateProductionRequest request) {

        return CommonResponse
                .<ProductionResponse>builder()
                .success(true)
                .message(
    ...
    @GetMapping
    public CommonResponse<List<ProductionResponse>>
    search(
        ...
        return CommonResponse
                .<List<ProductionResponse>>builder()
                .success(true)
                .message(
                        "Production entries fetched successfully")
                .data(
    ...
    @GetMapping("/{id}")
    public CommonResponse<ProductionDetailsResponse>
    getById(
            @PathVariable UUID id
    ) {

        return CommonResponse
                .<ProductionDetailsResponse>builder()
                .success(true)
                .message(
                        "Production details fetched successfully")
                .data(
    ...
    @PutMapping("/{id}")
    public CommonResponse<ProductionResponse> update(
            @PathVariable UUID id,
    ...
    exportPdf(
        ...
        byte[] pdf =
                productionService.exportPdf(id);
