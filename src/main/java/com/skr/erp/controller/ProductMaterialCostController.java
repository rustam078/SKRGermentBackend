...
public class ProductMaterialCostController {
    ...
    public CommonResponse<ProductMaterialCostResponse> addMaterialCost(
        ...
        return CommonResponse
                .<ProductMaterialCostResponse>builder()
                .success(true)
                .message("Material cost added successfully")
                .data(
                        productMaterialCostService.addMaterialCost(
                                productId,
                                request))
                .build();
    }
    ...
    public CommonResponse<List<ProductMaterialCostResponse>>
    getMaterialCosts(
            @PathVariable UUID productId) {

        return CommonResponse
                .<List<ProductMaterialCostResponse>>builder()
                .success(true)
                .message("Material costs fetched successfully")
                .data(
                        productMaterialCostService.getMaterialCosts(
                                productId))
                .build();
    }

    @PutMapping("/{id}")
    public CommonResponse<ProductMaterialCostResponse> update(
            @PathVariable UUID id,
            @Valid @RequestBody UpdateMaterialCostRequest request) {
        ...
        return CommonResponse
                ...
                .data(
                        productMaterialCostService.update(id, request))
                .build();
    }

    @GetMapping("/{productId}/current")
    public CommonResponse<BigDecimal>
    getMaterialCostByDate(
            @PathVariable UUID productId,
        ...
        return CommonResponse
                ...
                .data(
                        productMaterialCostService.getMaterialCostByDate(
                                productId,
                                date))
                .build();
    }
